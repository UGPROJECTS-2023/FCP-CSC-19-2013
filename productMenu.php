							...
							<div class="col-sm-2">
								<div class="select-wrapper" style="width: auto" >
									<select name="type" id="type" required style="background-color:white;color: black;">
										<option value="all" style="color: green;">List All</option>
										<option value="fruit" style="color: green;">Fruit</option>
										<option value="vegetable" style="color: green;">Vegetable</option>
										<option value="grain" style="color: ;">Grains</option>
									</select>
							  	</div>
							</div>
							<div class="col-sm-2">
