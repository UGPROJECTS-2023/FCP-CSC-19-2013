                ...
                <form method="post" action="buyNow.php?pid=<?= $pid; ?>" style="border: 1px solid black; padding: 15px;">
                    ...
                    <div class="row uniform">
                        <div class="4u 12u$(xsmall)">
                            <input type="text" name="0000" id="0000" value="" placeholder="0000" required/>
                        </div>
                        <div class="8u 12u$(xsmall)">
                            <input type="text" name="addr" id="addr" value="" placeholder="0000 0000 0000 0000 " style="width:80%" required/>
                        </div>
                    </div>
                    <br />
                    <p>
