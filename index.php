	...
	?>
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">FEDERAL UNIVERSITY DUTSE JIGAWA STATE<span>FUD</span></p>
			</div>
			<div>
				<i class="fa fa-phone"></i>
				<p style="font-size:20px">+2348109609616</p>
			</div>
			<div>
				<i class="fa fa-envelope"></i>
				<p style="font-size:20px"><a href="mailto:agroculture@gmail.com" style="color:white">Aliyuuk22@gmail.com</a></p>
			</div>
		</div>
		...
		<div class="footer-right">
			...
			<div class="footer-icons">
				<a  href="http://www.facebook.com/aliyu.usmankasim.10"><i style="margin-left: 0;margin-top:5px;"class="fa fa-facebook"></i></a>
